...
public class FetchFeaturedProductsTask extends AsyncTask<Void, Void, List<Product>> {

    //private final String API_ENDPOINT = "http://10.0.2.2:52144/api/product/featured/";
    private final String API_ENDPOINT = "http://zendo.gear.host/api/product/featured/";

    private WeakReference<Context> context;
    private OnProductsFetchListener listener;

    public FetchFeaturedProductsTask(Context context, OnProductsFetchListener listener) {
